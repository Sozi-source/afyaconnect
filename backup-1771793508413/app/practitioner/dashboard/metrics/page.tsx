      ...
      {currentMetrics && (
        ...
        >
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/client/dashboard/consultations" className="text-sm text-blue-600 hover:text-blue-700 flex items-center">
                    View all
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4">
            <Link href="/client/dashboard/metrics/details">
            ...
            <Link href="/client/dashboard/metrics/practitioners">
              <Card hoverable className="text-center p-4">
