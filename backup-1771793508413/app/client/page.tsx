      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <Link href="/client/dashboard/consultations" className="text-sm text-blue-600 hover:text-blue-700">
              View all
            </Link>
          </div>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <Link href="/client/dashboard/practitioners" className="text-sm text-blue-600 hover:text-blue-700">
              View all
            </Link>
          </div>
        </CardHeader>
