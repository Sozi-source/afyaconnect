  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-white font-sans overflow-x-hidden">
      ...
      <header className="bg-white/80 backdrop-blur-md border-b border-slate-200 sticky top-0 z-50">
        ...
        {/* Secondary header - Mobile optimized */}
          ...
          <div className="flex items-center justify-between min-w-max sm:min-w-0">
            ...
            <div className="flex items-center gap-1 sm:gap-2 ml-2">
              <button 
                ...
                className={`p-1.5 rounded-md transition flex-shrink-0 ${selectedView === 'grid' ? 'bg-white border border-slate-200 shadow-sm text-emerald-600' : 'text-slate-400 hover:text-slate-600 hover:bg-slate-100'}`}
              >
                <Squares2X2Icon className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
              </button>
              <button 
                onClick={() => setSelectedView('list')}
                className={`p-1.5 rounded-md transition flex-shrink-0 ${selectedView === 'list' ? 'bg-white border border-slate-200 shadow-sm text-emerald-600' : 'text-slate-400 hover:text-slate-600 hover:bg-slate-100'}`}
              >
      ...
      <main className="px-3 sm:px-4 md:px-6 py-4 sm:py-5 md:py-6 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 mb-5 sm:mb-6 md:mb-8">
          <div>
            <h1 className="text-lg sm:text-xl md:text-2xl font-semibold text-slate-900">Platform overview</h1>
            <p className="text-xs sm:text-sm text-slate-500 mt-0.5 sm:mt-1 flex items-center gap-1 sm:gap-2">
              <ChartBarIcon className="w-3.5 h-3.5 sm:w-4 sm:h-4 flex-shrink-0" />
              <span className="truncate">{stats.practitionerCount} practitioners · {stats.cityCount} cities</span>
            </p>
          </div>
          <div className="flex gap-2 sm:gap-3">
            <Link href="/about" className="flex-1 sm:flex-none">
              <button className="w-full px-3 sm:px-4 py-2 text-xs sm:text-sm border border-slate-200 bg-white hover:bg-slate-50 text-slate-600 rounded-lg shadow-sm transition flex items-center justify-center gap-1 sm:gap-2">
                <DocumentTextIcon className="w-3.5 h-3.5 sm:w-4 sm:h-4 flex-shrink-0" />
                <span className="hidden xs:inline">Docs</span>
                <span className="xs:hidden">?</span>
              </button>
            </Link>
            <Link href="/register" className="flex-1 sm:flex-none">
              <button className="w-full px-3 sm:px-4 py-2 text-xs sm:text-sm bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg shadow-sm hover:shadow transition flex items-center justify-center gap-1 sm:gap-2">
          ...
          <div className="space-y-4 sm:space-y-5 md:space-y-6">
            ...
            <AdminCard>
              ...
              <div className="p-3 sm:p-4 md:p-5 space-y-3 sm:space-y-4">
                <div className="flex items-center gap-2 sm:gap-3 text-xs sm:text-sm text-slate-600 group hover:text-emerald-600 transition">
                  ...
                  <span className="truncate text-[10px] sm:text-xs">support@afyaconnect.com</span>
                </div>
                <div className="flex items-center gap-2 sm:gap-3 text-xs sm:text-sm text-slate-600 group hover:text-emerald-600 transition">
                  <div className="p-1.5 sm:p-2 bg-slate-100 rounded-lg group-hover:bg-emerald-100 transition flex-shrink-0">
                    <PhoneIcon className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                  </div>
                  <span className="truncate text-[10px] sm:text-xs">+254 700 000 000</span>
                </div>
